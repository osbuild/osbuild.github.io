---
custom_edit_url: https://github.com/osbuild/osbuild/blob/main/docs/manifest.md
---
# Purpose
...
[//]: # ( Rather change the source of this: https://github.com/osbuild/osbuild/blob/main/docs/manifest.md )
-->
