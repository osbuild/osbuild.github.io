...
[`src/Components/ImagesTable/components/Row/components/Row.tsx`](https://github.com/osbuild/image-builder-frontend/tree/main/src/Components/ImagesTable/components/Row/components/Row.tsx).

### Mocking flags for tests

Flags are mocked globally in [`src/test/setup.ts`](https://github.com/osbuild/image-builder-frontend/tree/main/src/test/setup.ts) via `vi.mock('@unleash/proxy-client-react')`.
...
The tests are located in the [playwright/](https://github.com/osbuild/image-builder-frontend/tree/main/playwright/) directory and are identified by the `*.spec.ts` file extension.
...
Boot tests run automatically on PRs when they contain changes inside the [playwright/BootTests](https://github.com/osbuild/image-builder-frontend/tree/main/playwright/BootTests) directory.
