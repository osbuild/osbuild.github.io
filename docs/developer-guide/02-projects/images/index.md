...
[//]: # ( Rather change the source of this: https://github.com/osbuild/images/blob/main/README.md )
-->
...
[this example](https://github.com/osbuild/images/tree/main/data/repositories/centos-10.json).
...
[examples](https://github.com/osbuild/images/tree/main/data/repositories). Use `--force-repo-dir` and place the
